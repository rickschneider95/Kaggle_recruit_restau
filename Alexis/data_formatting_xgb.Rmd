...
data_air %>% 
  ...
  mutate(genre_name = case_when(genre_name == "NA" ~ genre_name))
...
This is the one hot encoding section (under form of functions) for the varaibles we start with in the complete dataset.
