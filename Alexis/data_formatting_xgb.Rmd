...
```{r}
#lat+long gives you better results
names(complete_data)
complete_data <- complete_data %>%
  mutate(location=latitude+longitude) %>%
  select(-latitude,-longitude)

#competition in neighborhood: how many restaurants of the same genre in the same neighbourhood
#table with count of restaurant types per neighborhood
